...
public static class LeviathanGrowthTree
{
    ...
    public static LeviathanSpecializationTree Create()
    {
        ...
        tree.Add(Node(
            ...
            2,
            LeviathanReq.Any(
                LeviathanReq.Rank(InternalHeatsinksId),
        ...
        tree.Add(Node(
            ...
            "Cold Blooded",
            1,
            LeviathanReq.Rank(ThermoregulationId),
            2,
            ...
            LeviathanFx.Increment(LeviathanGrowth.Knobs.HeatDissipationPercent, -50f),
            LeviathanFx.Increment(LeviathanGrowth.Knobs.MaxHeatPercent, 75f),
            LeviathanFx.Flag(LeviathanGrowth.Flags.ColdBlooded)
        ));
        ...
        tree.Add(Node(
            ...
            LeviathanFx.Flag(LeviathanGrowth.Flags.StarDragon)
        ));
        ...
        tree.Add(Node(
            ...
            "Sidewinder",
            2,
            LeviathanReq.Rank(EnhancedReactionsId),
            1,
        ...
        tree.Add(Node(
            ...
            LeviathanFx.Increment(LeviathanGrowth.Knobs.ShipSizeCategoryIncrease, 1f),
            LeviathanFx.Flag(LeviathanGrowth.Flags.Gigantism)
        ));
        ...
        tree.Add(Node(
            ...
            LeviathanFx.Increment(LeviathanGrowth.Knobs.WeaponSlotsFlat, -2f),
            LeviathanFx.Increment(LeviathanGrowth.Knobs.GlobalDamagePercent, 25f),
            LeviathanFx.Flag(LeviathanGrowth.Flags.SpecializedPredator)
        ));
        ...
        tree.Add(Node(
            ...
            "Laminar Scutes",
            2,
            LeviathanReq.Rank(SwiftPredatorId),
            1,
            "Gain 5% Top Speed and reduce Leviathan high-speed air resistance by 30% per rank.",
            LeviathanFx.Increment(LeviathanGrowth.Knobs.TopSpeedPercent, 5f),
            LeviathanFx.Increment(LeviathanGrowth.Knobs.AirResistancePercent, -30f),
            LeviathanFx.Flag(LeviathanGrowth.Flags.LaminarScutes)
        ));
        ...
        tree.Add(Node(
            ...
            "Cooling Fins",
            1,
            LeviathanReq.Rank(LaminarScutesId),
            2,
            ...
            LeviathanFx.Flag(LeviathanGrowth.Flags.CoolingFins)
        ));
        ...
        tree.Add(Node(
            ...
            LeviathanReq.Any(
                LeviathanReq.Rank(LaminarScutesId),
                LeviathanReq.Rank(SidewinderId)
            ),
            2,
            "Reduce Mass by 6% per rank.",
            LeviathanFx.Increment(LeviathanGrowth.Knobs.MassPercent, -6f)
        ));
        ...
        tree.Add(Node(
            ...
            3,
            LeviathanReq.Rank(StarDragonId),
            1,
            ...
            LeviathanFx.Ranks(LeviathanGrowth.Knobs.SupernovaCollapseHeatPercent, 200f, -15f, -15f),
            LeviathanFx.Ranks(LeviathanGrowth.Knobs.SupernovaDisableSeconds, 2f, -1f, -1f),
            LeviathanFx.Flag(LeviathanGrowth.Flags.CoronalMassEjection)
        ));
    ...
    private static LeviathanSpecializationNode Node(
        string id,
        string name,
        int maxRank,
